...
import { proyectsUI_UX } from '../../modules/proyects/proyectsEnum'
							...
							{proyectsUI_UX.map((proyect, index) => {
								...
								return (
									<SectionItem
										...
										imageSrc={proyect.imageSrc}
										duration={proyect.duration}
										role={proyect.role}
										typeOfWork={proyect.typeOfWork}
										content={proyect.content}
										figmaLink={proyect.figmaLink}
										mediumLink={proyect.mediumLink}
										prevProyect={
											prevProyect
												? prevProyect.title
												: 'Proyectos'
